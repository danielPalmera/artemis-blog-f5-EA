...
export const mockPostsData: Post[] = [
    {
        ...
        excerpt: "After nearly 10 days and 694,481 miles around the Moon and back, the Orion spacecraft splashed down safely off the coast of San Diego on April 10, 2026.",
        coverImage: {
        ...
        content: "<h2>Welcome Home: Artemis II Closes a Historic Chapter</h2><p>On April 10, 2026, the Orion spacecraft splashed down in the Pacific Ocean off the coast of San Diego...</p>",
        readingTime: 4
    },
    {
        id: "5",
        publishedAt: "2026-04-07",
        title: "Orion's Lunar Flyby: Seeing the Far Side of the Moon Like Never Before",
        slug: "orion-lunar-flyby-far-side-moon",
        excerpt: "During the Artemis II lunar flyby, the crew captured unprecedented imagery of the Moon's far side...",
        coverImage: {
        ...
        content: "<h2>A Unique Vantage Point: The Far Side of the Moon</h2><p>During the Artemis II lunar flyby...</p>",
        readingTime: 5
    },
    {
        id: "4",
        publishedAt: "2026-04-06",
        title: "Artemis II Crew Breaks the All-Time Human Spaceflight Distance Record",
        slug: "artemis-ii-crew-breaks-human-spaceflight-distance-record",
        excerpt: "Six days into their mission, the four Artemis II astronauts surpassed 248,655 miles from Earth...",
        coverImage: {
        ...
        content: "<h2>Farther Than Any Human Has Ever Been</h2><p>On April 6, 2026...</p>",
        readingTime: 6
    },
    {
        id: "3",
        ...
        excerpt: "For the first time since Apollo 17, human beings broke free of Earth's orbit...",
        coverImage: {
        ...
        content: "<h2>Breaking Free: The Translunar Injection Burn</h2><p>On the second day...</p>",
        readingTime: 4
    },
    {
        id: "2",
        ...
        excerpt: "NASA's SLS rocket lifted off from Kennedy Space Center on April 1, 2026...",
        coverImage: {
        ...
        content: "<h2>April 1, 2026: A Historic Day for Human Spaceflight</h2><p>At 6:35 p.m. EDT...</p>",
        readingTime: 5
    },
    {
        id: "1",
        ...
        excerpt: "A detailed breakdown of the 10-day schedule for the Artemis II crewed mission...",
        coverImage: {
        ...
        content: "<h2>Artemis II: The First Crewed Flight Around the Moon</h2><p>Artemis II is NASA's first...</p>",
        readingTime: 11
    }
];